        ...
        <Card className="bg-[#1e1e2e] border-white/10 shadow-xl">
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-xs text-white/40">Model sẽ được dùng cho cả dịch và check key.</p>
                </div>
...
AIzaSy...`}
                    ...
                    />
                    <p className="text-xs text-white/40">Mỗi dòng một Key. Hệ thống sẽ tự động chuyển Key khi key chính bị lỗi 429.</p>
                    ...
                    <div className="pt-2">
                        <Button
                            ...
                            className="w-full bg-white/5 hover:bg-white/10 text-indigo-300 border border-indigo-500/20"
                        >
                        ...
                        {keyStatuses.length > 0 && (
                            <div className="mt-2 space-y-1 max-h-[200px] overflow-y-auto p-2 bg-black/20 rounded border border-white/5 custom-scrollbar">
                                {keyStatuses.map((k, i) => (
                                    <div key={i} className="flex items-center justify-between text-xs px-2 py-2 rounded bg-white/5">
                                        <div className="flex items-center gap-2 truncate max-w-[70%]">
                                            ...
                                            <span className="font-mono text-white/70 truncate">{k.key}</span>
                                        </div>
                ...
                <div className="space-y-2 pt-4 border-t border-white/10">
                    ...
                    <p className="text-xs text-white/40">Nếu số từ dịch bị sai (14k thay vì 3k), bấm nút này để tính lại tất cả.</p>
                    <Button
                        size="sm"
                        variant="secondary"
                        onClick={fixAllWordCounts}
                        disabled={isFixingWordCount}
                        className="w-full bg-amber-500/10 hover:bg-amber-500/20 text-amber-300 border border-amber-500/20"
                    >
