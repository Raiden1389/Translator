...
export const TITLE_SUFFIXES = ['主', '长', '座', '王', '皇', '帝', '祖', '师', '尊', '姑', '姨', '妾', '子', '少', '爷', '圣女', '圣子', '天王', '官'];
...
export const FUNCTION_PREFIXES = [
    ...
    '一', '二', '三', '四', '五', '六', '七', '八', '九', '十', '百', '千', '万', '个', '又有', '还有', '已有', '设有', '两', '双', '尊',
    '向', '自', '对于', '关于', '甚至', '尽管', '虽然', '即使', '既然', '毕竟',
    '便', '却', '也', '但', '竟', '就', '连', '都', '并', '而', '已', '曾', '将', '被',
    '当年', '那时', '当时', '当初', '后来', '之前', '之后', '今', '及',
    '没有', '没', '无', '非', '不', '两人', '几个', '所有', '全部', '一些', '牢狱',
    '些', '而', '凭'
];

export const ACTION_PREFIXES = [
    '监', '返', '聽', '通', '要', '在', '进', '到', '入', '出', '斩', '杀', '破',
    '追', '随', '让', '给', '被', '为', '使', '令', '对', '向', '还', '把', '看', '神', '见', '用', '用到',
    '攻', '冲'
];
...
export const TRAILING_JUNK = [
    ...
    '了', '着', '过', '得', '地', ' của ', '之处', '之间', '时', '男子', '女子', '乐师', '船姑',
    '微微', '轻轻', '哈哈', '嘿嘿', '呵呵', '嘎嘎', '呜呜', '询', '羞', '浅', '冷', '吐', '又', '也', '还', '失', '微',
    '尽皆', '全都', '也都', '突然', '匆匆', '郑重', '竟然', '竟', '果然', '各自',
    '老太', '老太太', '老婆子', '香主', '村王', '连连', '纵身', '点', '点头', '则', '矣', '也',
    '纷纷', '这边', '惨', '赔', '已经', '自己'
];

export const TRAILING_VERBS = [
    '笑着', '笑道', '说罢', '走來', '过去', '缓缓', '慢慢', '轻轻', '悄悄', '默默',
...
export const HEURISTIC_BLACKLIST = [
    ...
    '哈哈', '呵呵', '嘿嘿', '嘻嘻', '嘎嘎', '呜呜', '咦', '噗嗤', '咯咯', '哪能',
    '哪里', '什么', '怎么', '为何', '谁', '哪个', '这时', '这些', '那些', '某位',
    '几乎', '仿佛', '似乎', '竟然', '难道', '果然', '既然', '必然', '果然',
    '总之', '特别是', '甚至于', '即便', '即便是', '与其', '不如', '之所以', '就是',
    '等等', '什么的', '祖宗', '老祖', '门外', '窗外', '不仅', '而且', '微微', '稍微',
    '各自', '年轻', '年轻男子', '年轻女子', '轻轻', '似笑非', '各个', '各处', '到处',
    '尸神', '尸神彭踞', '尸神彭踬', '天神', '经意间', '不经意间', '牢狱天王', '天王', '元神', '神识', '神官', '用到',
    '内阁', '叫花子', '船姑', '尸骨', '阵势'
];
